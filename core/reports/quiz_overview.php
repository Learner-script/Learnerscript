...
class core_reports_quiz_overview extends quiz_overview_table {
    ...
    /**
     * Report constructor
     * @param string $uniqueid Report unique id
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        if ($groupid && empty($this->filterparams->userid)) {
        ...
        if (isset($this->filterparams->edulevel) && ($this->filterparams->edulevel >= 0)) {
            ...
            list($edulevelsql, $edulevelparams) = $DB->get_in_or_equal([\core\event\base::LEVEL_OTHER,
        ...
        if (isset($this->filterparams->origin) && ($this->filterparams->origin != '')) {
            if ($this->filterparams->origin !== '---') {
                ...
                list($originsql, $originparams) = $DB->get_in_or_equal(['cli', 'restore', 'ws', 'web'],
