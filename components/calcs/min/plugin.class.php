...
class plugin_min extends pluginbase {
    ...
    public function init() {
        ...
        $this->reporttypes = ['courses', 'users', 'timeline',
        'categories', 'assignment', 'coursesoverview', 'gradedactivity',
        'myassignments', 'myquizs', 'quizzes', 'scorm', 'useractivities',
        'userassignments', 'usercourses', 'userquizzes', 'usersresources',
        'usersscorm', 'courseactivities', 'myscorm', ];
    }
    /**
     * This funtion returns the summary for minmum value
    ...
    /**
     * This function executes the calculated data
