...
/**
 * Average calculations plugin class
 */
class plugin_average extends pluginbase {
    ...
    public function init() {
        ...
        'scorm', 'useractivities', 'userassignments', 'usercourses', 'userquizzes',
        'usersresources', 'usersscorm', 'courseactivities', 'myscorm', ];
    }
    /**
     * Average summary function description
    ...
    /**
     * Average calculations execute function
     * @param array $rows List of rows data
     */
