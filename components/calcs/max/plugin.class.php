...
/** Maximum value calculation plugin class */
class plugin_max extends pluginbase {
    ...
    public function init() {
        ...
        'courses', 'coursesoverview', 'gradedactivity', 'myassignments',
        'myquizs', 'quizzes', 'scorm', 'useractivities', 'userassignments',
        'usercourses', 'userquizzes', 'usersresources', 'usersscorm', 'courseactivities', 'myscorm', ];
    }
    /**
    ...
    /**
     * This function executes the maximum value
